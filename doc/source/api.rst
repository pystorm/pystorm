...
Both :class:`pystorm.bolt.Bolt` and
:class:`pystorm.spout.Spout` inherit from a common base-class,
:class:`pystorm.component.Component`.  It handles the basic
...
.. autoclass:: pystorm.bolt.TicklessBatchingBolt
    :inherited-members:
    :show-inheritance:
